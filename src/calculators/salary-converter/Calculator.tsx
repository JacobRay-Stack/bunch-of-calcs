  ...
  return (
    ...
    >
      <div className="grid gap-6 sm:grid-cols-3">
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
          >
            {PERIODS.map((p) => (
      ...
      <div className="mt-8 overflow-hidden rounded-xl border border-gray-200">
        {PERIODS.map((period) => {
          ...
          return (
            <div
              key={period.key}
              className={`flex items-center justify-between border-b border-gray-100 last:border-0 px-5 py-4 transition-colors ${
                isInput
                  ? "bg-blue-50"
            ...
            >
              <div>
                <span className={`text-sm font-medium ${isInput ? "text-blue-700" : "text-gray-900"}`}>
                  {period.label}
                </span>
                {isInput && (
              ...
              <span
                className={`text-lg tabular-nums font-bold ${
                  isInput ? "text-blue-700" : "text-gray-900"
                }`}
              >
                {fmt(value)}
      ...
      <FAQ items={[
        ...
        { question: "Does this calculator account for taxes?", answer: "No, this is a straight pay conversion. It shows gross pay across different periods. For after-tax calculations, use our Self-Employment Tax Calculator or Side Hustle Tax Calculator." },
