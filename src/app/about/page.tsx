...
export const metadata: Metadata = {
  title: "About",
  description:
    "Bunch of Calcs builds free online calculators for freelancers and solopreneurs. Built by Jacob Ray.",
};
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <div className="mt-8 space-y-4 text-gray-600 dark:text-gray-300">
        <p>
          Hi, I&apos;m Jacob. I built Bunch of Calcs because I got tired of
          Googling the same financial questions every month as a freelancer.
          &quot;What should I charge?&quot; &quot;How much do I owe in
        ...
        <p>
          ...
          updated for 2026 with current federal brackets, SE tax rates, and state
